...
public class FlightBean implements Serializable {
    ...
    public void editFlight() {
        clearFacesMessages();
        if (selected != null) {
            // Copiar los datos del vuelo seleccionado al formulario
            this.flight = new Flight();
            this.flight.setId(selected.getId());
            this.flight.setFlightNumber(selected.getFlightNumber());
            this.flight.setOriginIata(selected.getOriginIata());
            this.flight.setDestinationIata(selected.getDestinationIata());
            this.flight.setDeparture(selected.getDeparture());
            this.flight.setArrival(selected.getArrival());
            this.flight.setPassengers(selected.getPassengers());
            this.flight.setPilot(selected.getPilot());
            this.flight.setAircraft(selected.getAircraft());
    ...
    public void deleteFlight() {
        if (selected != null) {
            ...
            FacesContext.getCurrentInstance().addMessage(null,
                new FacesMessage(FacesMessage.SEVERITY_INFO, "Vuelo eliminado", "El registro ha sido eliminado correctamente"));
            this.selected = null;
        }
    }
